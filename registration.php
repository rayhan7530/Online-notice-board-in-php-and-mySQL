...
<div class="pt">
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Student ID</td>
					<Td><input  type="text" placeholder="Student ID" class="form-control" name="stuid" required /></td>
				</tr>
				<tr>
					<td>Your Name</td>
					<Td><input  type="text" placeholder="Student Name" class="form-control" name="uname" required /></td>
				</tr>
				<tr>
					<td>Your Email </td>
					<Td><input type="email"  class="form-control" placeholder="Student E-mail" name="email" required /></td>
				</tr>
				...
				<tr>
					...
					<Td><input  class="form-control" type="text" placeholder="Student phone number" name="mob" required /></td>
				</tr>
